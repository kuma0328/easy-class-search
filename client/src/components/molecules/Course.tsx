...
export const Course = ({ courseInfo }: CourseProps) => {
  return (
    <>
      <Link to={`/course/${courseInfo.code}`}>
        <div className="justify-between mt-2 border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden p-5 bg-white hover:opacity-60 shadow-md">
